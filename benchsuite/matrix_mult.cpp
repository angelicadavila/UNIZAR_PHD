	...
	)
{
    ...
    // auto output = shared_ptr<vector<float,vecAllocator<float>>>(&matrixMult._out_aux);
	...
	binary_file =file_read_binary("./benchsuite/altera_kernel/matrix_mult.aocx"); 
