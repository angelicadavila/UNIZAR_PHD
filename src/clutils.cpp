...
string
CLUtils::clErrorToString(cl_int error)
{
  // OpenCL 1.2 enums
  switch (error) {
    case CL_SUCCESS:
...
// TODO(noz): [maybe-enhancement]
// have a look CL/cl.hpp Event.getInfo<cl_command_execution_status>()
string
CLUtils::clEnumToString(cl_int error)
{
  // OpenCL 1.2 enums
  switch (error) {
    case CL_COMPLETE:
